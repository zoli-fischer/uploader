...
var _Support = __webpack_require__(95);

var _Support2 = _interopRequireDefault(_Support);

var _FileInput = __webpack_require__(101);

var _FileInput2 = _interopRequireDefault(_FileInput);

var _DropZone = __webpack_require__(103);

var _DropZone2 = _interopRequireDefault(_DropZone);

var _Events2 = __webpack_require__(102);
...
var Uploader = function (_Events) {
    (0, _inherits3.default)(Uploader, _Events);

    function Uploader(options) {
        (0, _classCallCheck3.default)(this, Uploader);

        var _this = (0, _possibleConstructorReturn3.default)(this, (Uploader.__proto__ || (0, _getPrototypeOf2.default)(Uploader)).call(this, events));
...
var Options = function Options(options) {
    ...
    var optionsList = (0, _extends3.default)({
    ...
    (0, _keys2.default)(optionsList).forEach(function (key) {
...
var _Query = __webpack_require__(96);
...
var _values = __webpack_require__(97);
...
var QueryObject = function () {
    function QueryObject(selector) {
        ...
        (0, _classCallCheck3.default)(this, QueryObject);
        ...
        if ((typeof selector === 'undefined' ? 'undefined' : (0, _typeof3.default)(selector)) === 'object') {
            ...
            if (selector.indexOf('<') === 0) {
                ...
                (0, _values2.default)(document.querySelectorAll(selector)).forEach(function (queryElement) {
        ...
        this.elements = [];
        var i = 0;
        (0, _values2.default)(elements).forEach(function (element) {
    ...
    (0, _createClass3.default)(QueryObject, [{
        key: 'find',
        value: function find(selector) {
            var elements = [];
            (0, _values2.default)(this.elements).forEach(function (element) {
                (0, _values2.default)(element.querySelectorAll(selector)).forEach(function (queryElement) {
                    elements.push(queryElement);
                });
            });
        ...
        value: function appendTo(selector) {
            ...
            if (parents) {
                parents.forEach(function (parentElement) {
                    (0, _values2.default)(_this2.elements).forEach(function (element) {
        ...
        value: function css(styles, value) {
            ...
            } else if ((typeof styles === 'undefined' ? 'undefined' : (0, _typeof3.default)(styles)) === 'object') {
        ...
        value: function forEach(callback) {
            (0, _values2.default)(this.elements).forEach(callback);
            return this;
        }
    }, {
        key: 'on',
...
var FileInput = function (_Events) {
    (0, _inherits3.default)(FileInput, _Events);

    function FileInput(options) {
        (0, _classCallCheck3.default)(this, FileInput);

        var _this = (0, _possibleConstructorReturn3.default)(this, (FileInput.__proto__ || (0, _getPrototypeOf2.default)(FileInput)).call(this, events));

        _this.options = (0, _extends3.default)({
            multiple: true
        }, options);
        _this.$form = (0, _Query2.default)('<form style="position: fixed; left: -10000px; top: -10000px; visibility: hidden;"><input type="file" /></form>');
...
var DropZone = function (_Events) {
    (0, _inherits3.default)(DropZone, _Events);

    function DropZone(options) {
        (0, _classCallCheck3.default)(this, DropZone);

        var _this = (0, _possibleConstructorReturn3.default)(this, (DropZone.__proto__ || (0, _getPrototypeOf2.default)(DropZone)).call(this, events));
    ...
    (0, _createClass3.default)(DropZone, [{
        ...
        value: function _getDroppedFiles(dataTransfer) {
            ...
            if (items && items.length && (items[0].webkitGetAsEntry || items[0].getAsEntry)) {
                var itemsList = [];
                (0, _values2.default)(items).forEach(function (item) {

...
var Uploader = function () {
    function Uploader(options) {
        ...
        this.DropZone = new _DropZone2.default({
    ...
    _createClass(DropZone, [{
        ...
        value: function _handleFileTreeEntries(entries, path) {
            ...
            entries.forEach(function (entry) {
                promises.push(_this._handleFileTreeEntry(entry, path));
            });
            ...
            return new Promise(function (resolve, reject) {
                ...
                if (entry.isFile) {
                    ...
                    dirReader.readEntries(function (entries) {
                        _this2._handleFileTreeEntries(entries, path + entry.name + '/').then(function (files) {
                            var _files = [];
                            files.forEach(function (file) {
                                if (file instanceof Array) {
                                    file.forEach(function (file) {

...
var Uploader = function (_Events) {
    ...
    _createClass(Uploader, [{
        ...
        value: function _setEvents() {
            ...
            this.DropZone.on('drop', function (event, files) {
                var _files = _this2._parseFiles(files);
                _this2.trigger('drop', _files);
                _this2._addFiles(_files);
            });
        ...
        key: '_parseFiles',
        value: function _parseFiles(files) {
            return files.map(function (file) {
                var relativePath = file.relativePath || file.relativepath || file.webkitRelativePath;
        ...
        value: function _addFiles(files) {
            this.files = [].concat(_toConsumableArray(this.files), _toConsumableArray(files));
...
var Options = function Options(options) {
    ...
    var optionsList = _Obj2.default.assign({
...
var FileInput = function (_Events) {
    ...
    function FileInput(options) {
        ...
        _this.options = _Obj2.default.assign({
            multiple: true
        }, options);
...
var Events = function () {
    ...
    _createClass(Events, [{
        ...
        value: function CustomEvent(type) {
            ...
            params = _Obj2.default.assign({ bubbles: false, cancelable: false, detail: undefined }, params);
